...
app = FastAPI(title="masscan-worker", docs_url=None, redoc_url=None)
...
async def startup() -> None:
    ...
    async def handle(msg) -> None:
        try:
            ...
            await process_scan(app.state.db, payload, cfg.masscan_rate, cfg.masscan_ports)
            await msg.ack()
    ...
    logger.info("masscan-worker ready")
